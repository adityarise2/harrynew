...
USERNAME = environ.get('USERNAME', "https://t.me/aj_adminn_bot")
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1001896070091'))
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/ccb9db43e62a2e524928e.jpg')
START_IMG = environ.get('START_IMG', 'https://telegra.ph/file/fc74b061a2530f5c0196a.jpg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002120388756'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002205259864'))
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1001899266690'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002115008104'))
